...
export const CAMERA_CONFIG = {
  ...
  // [UNIFORME] Mejora 1: la cámara sigue RÍGIDA la orientación de la nave (sin
  // resorte ni lookAhead por velocidad) — la nave queda clavada en el encuadre.
  // false revierte al resorte con lookAhead (feel anterior a la mejora 1).
  chaseRigid: true,
  chaseStiffness: 8, // [PERSONALIZABLE] solo aplica si chaseRigid=false (resorte de posición)
  orbit: {
